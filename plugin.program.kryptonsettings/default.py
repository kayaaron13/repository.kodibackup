...
# Addon Name: Krypton Advanced Settings
# Addon id: plugin.program.kryptonsettings
# Addon Provider: A2TheKay
...
fanart = xbmc.translatePath(os.path.join('special://home/addons/plugin.program.kryptonsettings', 'fanart.jpg'))
iconart = xbmc.translatePath(os.path.join('special://home/addons/plugin.program.kryptonsettings', 'icon.png'))
SETTINGS_PATH = os.path.join(xbmc.translatePath('special://profile/addon_data/plugin.program.kryptonsettings'), 'settings.xml')
...
def MENU(name):
    ...
    addDirPlayable("Write XML File to temporary location", 'url',500, '','Play it safe. Write your advanced settings to userdata/plugin.program.kryptonsettings/XML_FILES/ directory',editfile,'')
...
def removexmlfile(name):
    if os.path.exists(ACTIVESETTINGSFILE):
        ...
        notification('Krypton Advanced Settings', 'advancedsettings.xml removed', '4000', iconart)
...
def resetsettings(name):
    ...
    try:
        ...
        notification('Krypton Advanced Settings', 'No changes exist', '4000', iconart)
        return
    for id in all_ids:
        if id != 'viewtype':
            ADDON.setSetting(id, value="DISABLED")
    notification('Krypton Advanced Settings', 'All settings reset', '4000', iconart)
...
def write_xml(name,dir_path):
    ...
    for s in settings:
        try:
            ...
            pass
    if count > 0:
        write_to_file(dir_path, '<!-- Created using Krypton Advanced Settings addon -->\n<advancedsettings>\n', False)
        settinglist = ['video&lt;&gt;','audio&lt;&gt;','network&lt;&gt;','cache&lt;&gt;','edl&lt;&gt;','pvr&lt;&gt;','epg&lt;&gt;','samba&lt;&gt;','videolibrary&lt;&gt;','videodatabase&lt;&gt;','musicdatabase&lt;&gt;','musiclibrary&lt;&gt;','karaoke&lt;&gt;','pathsubstitution&lt;&gt;','mainlock&lt;&gt;']
    ...
    notification('Krypton Advanced Settings', 'File created', '4000', iconart)
    xbmc.executebuiltin("Container.Refresh")
